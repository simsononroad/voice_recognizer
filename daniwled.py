...
def wled_aurora():
    json_data = {"on":True,"bri":255,"transition":7,"ps":-1,"pl":-1,"nl":{"on":False,"dur":60,"mode":1,"tbri":0,"rem":-1},"udpn":{"send":False,"recv":True,"sgrp":1,"rgrp":1},"lor":0,"mainseg":0,"seg":[{"id":0,"start":0,"stop":75,"len":75,"grp":1,"spc":0,"of":0,"on":True,"frz":False,"bri":255,"cct":127,"set":0,"col":[[128,128,128],[0,0,0],[255,0,0]],"fx":38,"sx":24,"ix":128,"pal":50,"c1":128,"c2":128,"c3":16,"sel":True,"rev":False,"mi":False,"o1":False,"o2":False,"o3":False,"si":0,"m12":0}]}
    headers ={'content-type':'application/json'}
    r = requests.post(api_endpoint, data=json.dumps(json_data),headers=headers)
